...
import { Text, View, StyleSheet, Button, SafeAreaView, Alert, TextInput, Dimensions,TouchableOpacity, StatusBar, ScrollView } from 'react-native';
...
const Profile = () => {
  ...
  return (
    ...
    <View style = {{windth : windowWidth, height: windowHeight, backgroundColor : '#68c2ff'}}>
     ...
     <TouchableOpacity style={styles.button} onPress={() => alert('프로필 사진 업데이트 기능 추가 중')}>
